<template>
  <router-link v-slot="{ href, isActive, navigate }" :to="to" custom>
    <a
      ...
      :href="href"
      class="text-slate-50 dark:text-slate-100 w-10 h-10 my-2 flex items-center justify-center rounded-lg hover:bg-slate-25 dark:hover:bg-slate-700 dark:hover:text-slate-100 hover:text-slate-600 relative"
      :class="{
