...
function setup_ssl() {
  ...
  wget https://raw.githubusercontent.com/sendingtk/chatwoot/develop/deployment/nginx_chatwoot.conf
...
function upgrade_cwctl() {
    wget https://raw.githubusercontent.com/sendingtk/chatwoot/master/deployment/setup_20.04.sh -O /usr/local/bin/cwctl > /dev/null 2>&1 && chmod +x /usr/local/bin/cwctl
}
